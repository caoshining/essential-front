        ...
        diyUpload:function( opt, serverCallBack ) {
			...
			webUploader.on('error', function( code ) {
				...
				switch( code ) {
					...
					break;
					case  'Q_EXCEED_NUM_LIMIT' : text = '上传文件数量超过'+opts.fileNumLimit+'个限制!' ;
					break;
					case  'F_EXCEED_SIZE' : text = '文件大小超过'+opts.fileSingleSizeLimit/(1024*1024)+'M限制!';
					break;
					case  'Q_EXCEED_SIZE_LIMIT' : text = '所有文件总大小超过'+opts.fileSizeLimit/(1024*1024)+'M限制!';
					break;
