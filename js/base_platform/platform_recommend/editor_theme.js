...
getProductId(oneListData.recommendId);
function getProductId(recommendId){
    productIdArr = [];
    var parmaData = {
        ...
        success:function (res){
            if(res.code == 1){
                ...
                $.each(res.info.relatedProducts,function (i,v){
                    productIdArr.push(v.productId.toString());
                });
                addGoodsList();
            }else{
                alert(res.msg);
...
/*创建人*/
$('.editorBox .CreateThemeAuthor').val(oneListData.createUserName);
/*样式选择*/
$('input:radio[name="radioChoose"]').eq(oneListData.recommendType-1).attr('checked','checked');

/*标题*/
$('.CreateThemeTitle').val(oneListData.recommendTitle);
/*封面图*/
$('.showImg1').attr('src',oneListData.coverPic);
/*主图*/
$('.showImg2').attr('src',oneListData.mainPicPath);
/*活动简介*/
$('.CreateThemeAbstract').html(oneListData.recommendIntroduction);
/*描述*/
$('.CreateThemeDescription').html(oneListData.recommendDescription);
...
function addGoodsList(){
    ...
    /*商品区*/
    newPushMsg_goods(productName,brandId,firstPrice,secondPrice,shopName,categoryId,linkFrom,articleNumber);

    function newPushMsg_goods(productName,brandId,firstPrice,secondPrice,shopName,categoryId,linkFrom,articleNumber){
        var parmaData = {
            pageIndex:1,
            type:0,
            pageSize:20,
        ...
        $.ajax({
            ...
            beforeSend:function(){
                ...
                $('.relatedProductsList tbody').append("<img class='Img_Load' src='assets/css/images/loading.gif'>");
            },
            success:function (res){
                ...
                if(res.code == 1){
                    ...
                    $('.pagination4_span').html('共'+Math.ceil(res.info.pageCount/20)+'页  每页20条')
                    $('.relatedProductsList tbody').html(result);
                    pagePlus(res.info.pageCount,productName,brandId,firstPrice,secondPrice,shopName,categoryId,linkFrom,articleNumber);
                }
    ...
    function newPushMsg_goodsForPage(page,productName,brandId,firstPrice,secondPrice,shopName,categoryId,linkFrom,articleNumber){
        var parmaData = {
            pageIndex:page,
            type:0,
            pageSize:20,
    ...
    //商品分页
    function pagePlus(totalPageCount,productName,brandId,firstPrice,secondPrice,shopName,categoryId,linkFrom,articleNumber){
        ...
        $('.pagination4').paging(totalPageCount, {
            ...
            onSelect: function(page) {
                ...
                newPushMsg_goodsForPage(page,productName,brandId,firstPrice,secondPrice,shopName,categoryId,linkFrom,articleNumber)
            },
...
$('.nextButton1').on('click',function (){
    ...
    if($('.CreateThemeAuthor').val() == ''){
        ...
        var coverPic = $('.showImg1').attr('src');
        var mainPicPath = $('.showImg2').attr('src');;
        ...
        parmaData = {
            ...
            modifyUser:userId,
            recommendId:oneListData.recommendId
        };
...
$('.save1').on('click',function (){
    ...
    $.ajax({
        type: "post",
        url: PLATFORM_URL_PRE+'/essential/recommend/update',
        dataType: 'json',
        data:parmaData,
        success:function (res){
            if(res.code == 1){
